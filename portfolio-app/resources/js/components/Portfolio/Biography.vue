<template>
    <div class="container">
        <h2>Über mich</h2>
        <p>
            Ich bin ein leidenschaftlicher Software- und Web-Entwickler mit Erfahrung in modernen Web-Technologien.
            Mein Schwerpunkt liegt auf der Entwicklung von Backends mithilfe von PHP und dem Symfony Framework
            oder dem Laravel Framework.<br>
            Für die Entwicklung von passenden Frontends nutze ich Vue.JS.
            ...
            Neben meinen beruflichen Tätigkeiten entwickle ich als Hobby Videospiele in der Unreal Engine
            und nutze hierfür C++ um die Möglichkeiten der Engine an Anforderungen meiner Projekte anzupassen.
        </p>
    </div>
</template>
